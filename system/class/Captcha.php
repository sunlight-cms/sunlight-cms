    ...
    static function init()
    {
        ...
        if (_captcha && !_logged_in) {
            ...
            return array(
                ...
                'content' => "<input type='text' name='_cp' class='inputc' autocomplete='off'><img src='" . \Sunlight\Router::link('system/script/captcha/image.php?n=' . $captchaCounter) . "' alt='captcha' title='" . _lang('captcha.help') . "' class='cimage'><input type='hidden' name='_cn' value='" . $captchaCounter . "'>",
                'top' => true,
                'class' => 'captcha-row',
            );
        } else {
