...
Žádost byla odeslána %date% z počítače %ip%.',
    ...
    'mod.reg.passwordtoolong' => 'heslo je příliš dlouhé',
...
Žádost byla odeslána %date% z počítače %ip%.',
    ...
    'mod.settings.password.error.not_same' => 'nové heslo a jeho kontrola se neshodují',
    'mod.settings.password.error.empty' => 'nové heslo nesmí být prázdné',
    'mod.settings.password.error.too_long' => 'nové heslo je příliš dlouhé',
...
Odesílatel uvedl svou adresu jako: %sender%',
    ...
    'xsrf.warning' => 'Pozor! Pokud jste se na tuto stránku dostali aniž byste osobně vyplnili formulář na této doméně (%domain%), akci neopakujte! Může se jednat o pokus zneužít vaše přihlášení.',
