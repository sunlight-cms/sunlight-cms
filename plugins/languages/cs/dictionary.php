...
Žádost byla odeslána %date% z počítače %ip%.',
    ...
    'mod.settings.avatar.hint' => 'Maximální velikost nahraného obrázku je <strong>%maxsize%</strong> a rozměry <strong>%maxw% x %maxh% pixelů</strong>. Obrázek bude zmenšen a ořezán.',
    'mod.settings.avatar.remove' => 'odstranit avatar',
    'mod.settings.password' => 'Nastavení hesla',
    'mod.settings.password.hint' => 'Pole současné heslo vyplňujte pouze v případě, že chcete změnit heslo, e-mailovou adresu nebo stáhnout svá osobní data.',
    ...
    'mod.settings.download_personal_data' => 'Osobní data',
    'mod.settings.download_personal_data.action' => 'Stáhnout osobní data',
    'mod.settings.download_personal_data.hint' => 'Zde máte možnost stáhnout si svá osobní data ve formátu CSV. Před stažením je potřeba vyplnit pole &quot;současné heslo&quot; výše.',
