...
if ($continue) {
  ...
  ";
    if (!$new) {
        $custom_settings .= " <label><input type='checkbox' name='delposts' value='1'> " . _lang('admin.content.form.deltopics') . "</label><small>(" . DB::count(_posts_table, 'home=' . DB::val($id) . ' AND type=' . _post_forum_topic . ' AND xhome=-1') . ")</small>";
    }
