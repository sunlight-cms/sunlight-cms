...
if ($continue) {
  ...
  ";
    if (!$new) {
        $custom_settings .= " <label><input type='checkbox' name='delposts' value='1'> " . $_lang['admin.content.form.deltopics'] . "</label><small>(" . DB::result(DB::query("SELECT COUNT(*) FROM " . _posts_table . " WHERE home=" . $id . " AND type=5 AND xhome=-1"), 0) . ")</small>";
    }
