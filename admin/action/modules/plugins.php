...
$output .= '<p>
        ...
        <a class="button right" href="https://sunlight-cms.cz/resource/v8/get-plugins" target="_blank"><img src="' . _e(Router::path('admin/public/images/icons/show.png')) . '" alt="get" class="icon">' . _lang('admin.plugins.get') . '</a>
</p>
';
