...
$output .= '<p>
        ...
        <a class="button right" href="https://sunlight-cms.org/goto/get-plugins" target="_blank"><img src="images/icons/show.png" alt="get" class="icon">' . $_lang['admin.plugins.get'] . '</a>
</p>
';
