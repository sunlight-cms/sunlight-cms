...
if ($continue) {
  ...
  ";
    if (!$new) {
        $custom_settings .= "<tr><td colspan='2'><label><input type='checkbox' name='delcomments' value='1'> " . _lang('admin.content.form.delcomments') . " <small>(" . DB::count(_comment_table, 'home=' . DB::val($id) . ' AND type=' . _post_section_comment) . ")</small></label></td></td></td></tr>";
    }
}
