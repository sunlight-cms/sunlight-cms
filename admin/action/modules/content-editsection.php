...
if ($continue) {
    ...
    $custom_settings = "
  <tr><td colspan='2'><label><input type='checkbox' name='var1' value='1'" . _checkboxActivate($query['var1']) . "> " . _lang('admin.content.form.comments') . "</label></td></td></td></tr>
  <tr><td colspan='2'><label><input type='checkbox' name='var3' value='1'" . _checkboxActivate($query['var3']) . "> " . _lang('admin.content.form.commentslocked') . "</label></td></td></td></tr>
  ";
    if (!$new) {
