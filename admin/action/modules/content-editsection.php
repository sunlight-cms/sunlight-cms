...
if ($continue) {
    ...
    $custom_settings = "
  <tr><td colspan='2'><label><input type='checkbox' name='var1' value='1'" . \Sunlight\Util\Form::activateCheckbox($query['var1']) . "> " . _lang('admin.content.form.comments') . "</label></td></td></td></tr>
  <tr><td colspan='2'><label><input type='checkbox' name='var3' value='1'" . \Sunlight\Util\Form::activateCheckbox($query['var3']) . "> " . _lang('admin.content.form.commentslocked') . "</label></td></td></td></tr>
  ";
    if (!$new) {
